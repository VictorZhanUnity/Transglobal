...
namespace VictorDev.RevitUtils
{
    ...
    public static class RevitDataConverter
    {
        ...
        /// 取得指定Name的String值
        /// </summary>
        public static string GetStringValue(string jsonData, string valueName) => GetStringValue(JsonHelper.ParseJson(jsonData), valueName);
        /// <summary>
        /// 取得指定Name的String值
        /// </summary>
        ...
        /// 取得指定Name的Float值
        /// </summary>
        public static float GetFloatValue(string jsonData, string valueName) => GetFloatValue(JsonHelper.ParseJson(jsonData), valueName);
        /// <summary>
        /// 取得指定Name的Float值
        /// </summary>
        ...
        /// </summary>
        public static Vector3 ConvertToPosition(string jsonData) => ConvertToPosition(JsonHelper.ParseJson(jsonData));
        /// <summary>
        /// 座標轉換 (Revit的Z軸 = Unity的Y軸)
        /// </summary>
        ...
        /// Scale轉換 
        /// </summary>
        public static Vector3 ConvertToScale(string jsonData) => ConvertToScale(JsonHelper.ParseJson(jsonData));
